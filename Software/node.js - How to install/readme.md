...
This command downloads the `node-v0.10.31-linux-x64.tar.gz` and then saves it as `node.tar.gz` in your servers root directory.
...
~~~
cd && rm -rf node{.js.tar.gz,-v0.10.31-linux-x64}
~~~
